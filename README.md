...
> [!NOTE]
> 当前稳定版 **v1.6.3**，电池模块新增实时充放电功率与两分钟动态波形，系统状态模块也会显示当前电池功率。完整教程见[使用文档](https://muqy1818.github.io/OpenYoink/guide/)。
...
- **原生 Island**：全新安装默认启用并与 Mac 刘海融合；外接屏或无刘海设备使用顶部悬浮胶囊，含暂存架、传输、计时器、电池与正在播放模块。电池模块可查看实时功率与两分钟波形，各模块均可独立关闭。
